...
echo -e $red"      \$\$\$\$\$##WX!:      .<!!!!UW\$\$\$\$*  \$\$\$\$\$\$\$\$#"
echo -e $white"      \$\$\$\$\$  \$\$\$UX   :!!UW\$\$\$\$\$\$\$\$\$   4\$\$\$\$\$**"
echo -e $white"      ^\$\$\$B  \$\$\$\$\\     \$\$\$\$\$\$\$\$\$\$\$\$   d\$\$R*"
echo -e $white"        **\$bd\$\$\$\$      **\$\$\$\$\$\$\$\$\$\$\$o+#      ${yellow}*${white}GGmuxByMrB∆RB∆R"
echo -e $white"             ****          *******"
echo
echo -e $red"Author   : "$red"MrB∆RB∆R"
echo -e $red"Team     : "$red"Single"
echo -e $white"github   : "$white"https://github.com/MrBarBar05"
echo -e $white"Contact  : "$white"085693587969"
echo
echo -e $white "*===========================================================*"
echo
trap ctrl_c INT
...
echo -e $purple " [*] By MrB∆RB∆R :)..."
echo -e $blue " [*] Sampai Jumpa;) "
sleep 1
exit
}
lagi=1
...
echo -e $red "<|--------------------------------------------------------|>"
echo -e $red "[01] Termux BOM"
echo -e $red "[02] Termux Pedang"
echo -e $red "[03] Termux Suriken "
echo -e $white "[04] Termux Cap Lima Jari"
echo -e $white "[05] Termux Topeng Anonymouse"
echo -e $white "<|--------------------------------------------------------|>"
echo
echo ""
echo -e $blue "                  Tampilan Cowsay"
echo -e $red "<|--------------------------------------------------------|>"
...
echo -e $white "<|--------------------------------------------------------|>"
echo
echo -e $red "[00] ${red}Keluar"
echo
echo -e $white
read -p "┌──Roy@Ganteng~: └╼# " pil;
case $pil in
13) echo ""
echo ""
...
echo "echo" >> bash.bashrc
echo "echo -e '\e[0;36m' 'BISMILLAH'" >> bash.bashrc
...
sleep 3
echo -e $purple "[*] Silahkan Buka session baru Untuk Melihat Hasil"
sleep 3
else
...
;;
00) echo -e $purple " [*] Created By : MrB∆RB∆R"
sleep 1
echo -e $cyan " [*] Terima Kasih Yaa:)"
sleep 1
exit
;;
